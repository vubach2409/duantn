...
<div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
    <div class="row g-4">
        <div class="col-auto">
            <div class="avatar-lg">
                <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="user-img" class="img-thumbnail" />
            </div>
        ...
        <div class="col">
            <div class="p-2">
                ...
                <div class="hstack text-white-50 gap-1">
                    <div>
                        <i class="ri-phone-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{Auth::user()->phone}}
                    </div>
                </div>
                <div class="hstack text-white-50 gap-1">
                    <div>
                        <i class="ri-mail-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{Auth::user()->email}}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <div class="d-flex profile-wrapper">
                ...
                <div class="flex-shrink-0">
                    <a href="{{route('admin.profile.edit', Auth::user()->id)}}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                </div>
            </div>
            <!-- Tab panes -->
