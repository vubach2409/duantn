                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <form action="{{ route('auth.logout') }}" method="POST">
                        ...
                        <a class="dropdown-item" href="pages-profile.html"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>Thông tin tài
                            khoản</a>
                        ...
                        <button class="dropdown-item"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>Đăng xuất</button>
                    </form>
                </div>
            </div>
        </div>
