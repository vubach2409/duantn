...
<script src="{{ asset('client/assets/js/plugin.js') }}"></script>
<script src="{{ asset('client/assets/js/main.js') }}"></script>
<script src="{{ asset('client/assets/js/custom-nav.js') }}"></script>
<script src="{{ asset('client/assets/js/custom-swiper1.js') }}"></script>
<script src="{{ asset('client/assets/js/custom-singledate.js') }}"></script>
</body>
