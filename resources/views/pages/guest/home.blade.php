...
@section('content')
                                ...
                                <div class="room-item">
                                    ...
                                    <div class="room-content">
                                        <div class="room-title">
                                            ...
                                            <h4>{{ $article->title }}</h4>
                                            <div class="price">
                                                {{ number_format($article->room->price, 0, ',', '.') }}
                                                VNĐ
                                                <span>
                                                    @if ($article->room->status == 1)
                                                        Còn phòng
                                                    @else
                                                        Hết phòng
                                                    @endif
                                ...
                                <div class="room-item">
                                    ...
                                    <div class="room-content">
                                        <div class="room-title">
                                            ...
                                            <div class="price">
                                                {{ number_format($article->room->price, 0, ',', '.') }}
                                                VNĐ<span>{{ $article->room->status }}</span></div>
                                            <div class="text">{{ $article->description }}</div>
                                        </div>
                                        <div class="room-services mar-top-20">
                                            <ul>
    ...
    <section class="content gallery">
        <div class="section-title">
            ...
            <p class="mar-bottom-30">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ex neque, sodales accumsan sapien et, auctor
                vulputate quam donec vitae consectetur
                turpis
            </p>
        </div>
        <div class="container">
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery1.jpg" data-lightbox="gallery"
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery16.jpg" data-lightbox="gallery"
                                            data-title="Title"><i class="fa fa-eye"></i></a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-link"></i></a>
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery3.jpg" data-lightbox="gallery"
                                            data-title="Title"><i class="fa fa-eye"></i></a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-link"></i></a>
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery17.jpg" data-lightbox="gallery"
                                            data-title="Title"><i class="fa fa-eye"></i></a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-link"></i></a>
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery15.jpg" data-lightbox="gallery"
                                            data-title="Title"><i class="fa fa-eye"></i></a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-link"></i></a>
                    ...
                    <div class="brick">
                        <div class="gallery-item">
                            ...
                            <div class="gallery-content">
                                <ul>
                                    <li>
                                        <a href="images/gallery/gallery5.jpg" data-lightbox="gallery"
                                            data-title="Title"><i class="fa fa-eye"></i></a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-link"></i></a>
